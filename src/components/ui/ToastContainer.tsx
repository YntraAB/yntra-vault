...
export function ToastContainer() {
  ...
  return (
    <div className="fixed right-4 top-4 z-[60] flex flex-col gap-2 select-none">
      <AnimatePresence>
        {toasts.map((toast) => (
          <motion.div
            key={toast.id}
          ...
          >
            ...
            <button
              ...
              className="text-[var(--text-tertiary)] transition-colors hover:text-[var(--text-primary)] cursor-pointer"
            >
              <X size={12} />
            </button>
          </motion.div>
