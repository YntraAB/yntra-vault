...
export function TagContextMenu({ open, x, y, onClose, onAddPassword, onEdit, onDelete }: TagContextMenuProps) {
    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="fixed z-[60] min-w-[160px] rounded-md border border-[var(--border)] bg-[var(--bg-elevated)] py-1 shadow-xl select-none"
