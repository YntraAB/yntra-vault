      ...
      <div className="flex items-center justify-between rounded-[4px] border border-[var(--border-subtle)] bg-[var(--bg-elevated)] p-3.5">
        ...
        <ActionTooltip content={t('keybinds.reset_tooltip')}>
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-[3px] border border-[var(--border)] bg-[var(--bg-base)] px-2.5 py-1 text-[12px] font-medium text-[var(--text-secondary)] transition-colors hover:bg-[var(--bg-hover)] hover:text-[var(--text-primary)] active:scale-95 cursor-pointer"
          >
            <RotateCcw size={13} />
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {isRecording ? (
                      ...
                      >
                        <div className="flex h-8 items-center gap-1.5 rounded-[4px] border border-[var(--border-focus)] bg-[var(--bg-elevated)] px-2.5 text-[12px] font-medium text-[var(--text-primary)] shadow-xs select-none">
                        ...
                        <ActionTooltip content={t('keybinds.cancel')}>
                          <button
                            ...
                            className="flex h-8 w-8 items-center justify-center rounded-[4px] border border-[var(--border)] bg-[var(--bg-base)] text-[11px] font-medium text-[var(--text-tertiary)] transition-colors hover:bg-[var(--bg-hover)] hover:text-[var(--text-primary)] active:scale-95 cursor-pointer"
                          >
                            <X size={14} />
                          </button>
                        </ActionTooltip>
                      ...
                      <button
                        ...
                        className="group flex h-8 items-center gap-1 rounded-[4px] border border-[var(--border)] bg-[var(--bg-base)] px-2.5 transition-all hover:border-[var(--border-focus)] hover:bg-[var(--bg-hover)] cursor-pointer select-none"
                      >
                        <div className="flex items-center gap-1">
                          {displayKeys.map((k, i) => (
                            <span key={i} className="flex items-center gap-1">
