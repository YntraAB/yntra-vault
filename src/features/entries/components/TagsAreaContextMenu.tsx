...
export function TagsAreaContextMenu({
  open,
  x,
  y,
  onClose,
    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="fixed z-[60] min-w-[210px] rounded-md border border-[var(--border)] bg-[var(--bg-elevated)] py-1 shadow-xl select-none"
...
export default TagsAreaContextMenu;
