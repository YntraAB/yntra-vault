    ...
    <div className="flex flex-col gap-6">
        ...
        <SettingSection label={t('settings.active_vault')}>
          <div className="flex flex-col gap-2.5 rounded-[3px] border border-[var(--border)] bg-[var(--bg-elevated)] p-3">
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-[13px] font-medium text-[var(--text-primary)] select-text">{currentVault.name}</span>
            </div>
            <div className="flex flex-col gap-0.5">
            ...
            {isTauri() && (
              <button
                ...
                className="mt-1 h-7 self-start rounded-[3px] border border-[var(--border)] bg-[var(--bg-base)] px-2.5 text-[11px] font-medium text-[var(--text-primary)] transition-colors hover:bg-[var(--bg-hover)] cursor-pointer"
              >
      ...
      >
        ...
        <select
          ...
          className="h-8 w-full rounded-[3px] border border-[var(--border)] bg-[var(--bg-elevated)] px-2.5 text-[13px] text-[var(--text-primary)] outline-none focus:border-[var(--border-focus)] cursor-pointer"
        >
        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="h-1 w-full appearance-none rounded-full bg-[var(--border)] outline-none [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[var(--text-primary)] cursor-pointer"
            />
          </div>
          <div>
            <div className="flex justify-between items-center mb-1">
      ...
      <SettingSection label={t('onboarding.rerun_setup')}>
        <p className="mb-2 text-[12px] text-[var(--text-secondary)]">
          {t('settings.rerun_setup_desc') || 'Reset initial walkthrough and restart the setup wizard. Your current vault will be locked.'}
        </p>
        <button
          onClick={() => {
