...
pub enum VaultError {
    ...
    #[error("Invalid operation or state: {0}")]
    InvalidState(String),

    #[error("Smart Login error: {0}")]
    SmartLoginError(String),
}
...
impl From<yntra_crypto::CryptoError> for VaultError {
    fn from(err: yntra_crypto::CryptoError) -> Self {
        match err {
            yntra_crypto::CryptoError::EncryptionError(s) => VaultError::EncryptionError(s),
            yntra_crypto::CryptoError::DecryptionError(s) => VaultError::DecryptionError(s),
            yntra_crypto::CryptoError::InvalidPassword => VaultError::InvalidPassword,
            yntra_crypto::CryptoError::KdfError(s) => VaultError::KdfError(s),
            yntra_crypto::CryptoError::MemoryLockError(s) => VaultError::MemoryLockError(s),
            yntra_crypto::CryptoError::ClipboardError(s) => VaultError::ClipboardError(s),
            yntra_crypto::CryptoError::IntegrityError => VaultError::IntegrityError,
            yntra_crypto::CryptoError::BiometricNotAvailable(s) => VaultError::BiometricNotAvailable(s),
            yntra_crypto::CryptoError::BiometricAuthFailed(s) => VaultError::BiometricAuthFailed(s),
            yntra_crypto::CryptoError::BiometricCanceled => VaultError::BiometricCanceled,
            yntra_crypto::CryptoError::BiometricHardwareError(s) => VaultError::BiometricHardwareError(s),
            yntra_crypto::CryptoError::Hardware2FaNotAvailable(s) => VaultError::Hardware2FaNotAvailable(s),
            yntra_crypto::CryptoError::Hardware2FaAuthFailed(s) => VaultError::Hardware2FaAuthFailed(s),
            yntra_crypto::CryptoError::Hardware2FaRequired => VaultError::Hardware2FaRequired,
            yntra_crypto::CryptoError::TpmError(s) => VaultError::TpmError(s),
            yntra_crypto::CryptoError::PasskeyError(s) => VaultError::PasskeyError(s),
            yntra_crypto::CryptoError::IoError(e) => VaultError::IoError(e),
            yntra_crypto::CryptoError::InvalidFormat(s) => VaultError::InvalidFormat(s),
            yntra_crypto::CryptoError::SerializationError(s) => VaultError::SerializationError(s),
        }
    }
}
