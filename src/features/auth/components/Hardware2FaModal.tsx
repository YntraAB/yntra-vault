            ...
            <div className="p-4">
              {step === 'select' && (
                <div className="flex flex-col gap-3.5">
                  <div>
                    ...
                    <div className="mt-1.5 grid grid-cols-2 gap-2">
                      <button
                        ...
                        className={`flex flex-col items-center gap-1.5 rounded-[3px] border p-2.5 text-center transition-colors cursor-pointer ${
                          protocol === 'YubiKeyChallengeResponse'
                            ? 'border-[var(--border-focus)] bg-[var(--bg-active)] text-[var(--text-primary)] font-medium'
                            : 'border-[var(--border)] bg-[var(--bg-base)] text-[var(--text-secondary)] hover:border-[var(--border-focus)]'
                        }`}
                      >
                        <Cpu size={16} />
                        <span className="text-[11px]">YubiKey Challenge-Response</span>
                      </button>
                      <button
                        type="button"
                      ...
                      >
                        <ShieldCheck size={16} />
                        <span className="text-[11px]">FIDO2 / CTAP2 (HMAC-Secret)</span>
                      </button>
                    </div>
                  </div>
                  ...
                  {mode === 'enroll' && (
                    <>
                      <div className="rounded-[3px] border border-[var(--border)] bg-[var(--bg-base)] p-3 text-[12px] text-[var(--text-secondary)]">
                        <p className="font-semibold text-[var(--text-primary)]">Strict Two-Factor Authentication</p>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="mt-1.5 h-8 w-full rounded-[3px] border border-[var(--border)] bg-[var(--bg-base)] px-3 text-[12px] text-[var(--text-primary)] outline-none focus:border-[var(--border-focus)] transition-colors"
                        />
                      </div>
                      ...
                      <div>
                        <div className="flex items-center justify-between">
                          ...
                          {keyFilePath && (
                            <button
                              ...
                              className="text-[11px] text-[var(--text-tertiary)] hover:text-[var(--text-primary)] cursor-pointer transition-colors"
                            >
                              Remove
                            </button>
                          )}
                        ...
                        <div className="mt-1.5 flex gap-2">
                          <input
                            ...
                            className="h-8 flex-1 rounded-[3px] border border-[var(--border)] bg-[var(--bg-base)] px-3 text-[12px] text-[var(--text-primary)] outline-none"
                          />
                          <button
                            type="button"
                      ...
                      <div className="mt-2 flex flex-col gap-1.5">
                        {keys.map((k) => (
                          <div key={k.id} className="flex items-center justify-between text-[12px]">
                            ...
                            <span className="inline-flex items-center gap-1 rounded-[3px] bg-[var(--bg-elevated)] px-2 py-0.5 font-mono text-[10px] text-[var(--text-secondary)] border border-[var(--border)]">
                              {t('hw.connected')}
                            </span>
                          </div>
                        ))}
                  ...
                  {error && (
                    <div className="flex items-center gap-2 rounded-[3px] border border-[var(--border)] bg-[var(--bg-base)] p-3 text-[12px] text-[var(--text-primary)]">
              ...
              {step === 'prompt' && (
                <div className="flex flex-col items-center justify-center py-6 text-center">
                  <motion.div
                    ...
                    className="flex h-14 w-14 items-center justify-center rounded-[3px] border border-[var(--border)] bg-[var(--bg-base)] text-[var(--text-primary)]"
                  >
                    <KeyRound size={26} />
                  </motion.div>
                  ...
                  <RefreshCw size={14} className="mt-3.5 animate-spin text-[var(--text-secondary)]" />
                </div>
              )}

              {step === 'success' && (
                <div className="flex flex-col items-center justify-center py-6 text-center">
                  <div className="flex h-12 w-12 items-center justify-center rounded-[3px] border border-[var(--border)] bg-[var(--bg-base)] text-[var(--text-primary)]">
            ...
            {step === 'select' && (
              <div className="flex justify-end gap-2 border-t border-[var(--border)] px-4 py-3 bg-[var(--bg-surface)]">
                ...
                <button
                  ...
                  className="flex h-8 items-center gap-2 rounded-[3px] bg-[var(--text-primary)] px-3.5 text-[12px] font-semibold text-[var(--bg-base)] hover:opacity-90 transition-opacity disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed"
                >
