      ...
      >
        ...
        >
          ...
          <p className="mt-4 text-[13px] text-[var(--text-secondary)] leading-relaxed">
            ...
            <span className="font-bold text-[var(--text-primary)] bg-[var(--bg-elevated)] px-2 py-0.5 rounded border border-[var(--border)] inline-flex items-center gap-1.5 my-0.5 shadow-sm align-middle">
              <span
          ...
          {tag.count > 0 && (
            <p className="mt-2 text-[12px] text-[var(--text-tertiary)] leading-normal">
              {tag.count === 1
