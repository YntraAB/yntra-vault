        ...
        <div className="flex gap-2">
          {([
            ...
            <button
              ...
              className={`flex h-[72px] w-[100px] flex-col items-center justify-center gap-1.5 rounded-[3px] border text-[12px] font-medium transition-colors cursor-pointer select-none ${
                theme === tItem.value
      ...
      <SettingSection label={t('settings.font_size')}>
        <div className="flex items-center gap-4">
          <input
            ...
            className="h-1 flex-1 appearance-none rounded-full bg-[var(--border)] outline-none [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[var(--text-primary)] cursor-pointer"
          />
        ...
        <div className="flex rounded-[3px] border border-[var(--border)]">
          {(['compact', 'normal', 'comfortable'] as const).map((d) => (
            <button
              ...
              className={`flex-1 py-1.5 text-[12px] font-medium capitalize transition-colors cursor-pointer select-none ${
                settings.density === d
